...
<html lang="ja">
	...
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&family=Roboto:wght@200;300;400;500;700&display=swap" rel="stylesheet">
        ...
        <link rel="stylesheet" type="text/css" href="./css/style.css?ver=20250428" />
    ...
    <header class="header" id="header">
		<div class="container">
			<video src="./videos/istockphoto-1438537439-640_adpp_is.mp4" autoplay loop muted></video>
			<nav class="gnav js-header">
				<div class="logo js-header"><a href="index.html">
					<img src="./images/logo_white.svg" alt="テックプロパティジャパン" class="-before">
					<img src="./images/logo.svg" alt="テックプロパティジャパン" class="-after"></a></div><!-- end .logo -->
				<ul class="gnav-list">
					<li><a href="index.html" class="js-header rolltext">HOME</a></li>
					<li class="gnav-list__item megamenu"><a href="./service/index.html" class="js-header rolltext">SERVICE
						...
						<div class="downMenu1">
							<ul class="downMenu-list">
								<li class="downMenu-list__item"><a href="./service/club20.html" class="rolltext">利回り20%倶楽部</a></li>
								<li class="downMenu-list__item"><a href="./service/new_apartment.html" class="rolltext">新築アパートプラン</a></li>
								<li class="downMenu-list__item"><a href="./service/assessment.html" class="rolltext">不動産査定</a></li>
							</ul>
						</div>
					</li>
					<li><a href="http://52.0.121.178/id/techpro-j/wp/?page_id=6" class="js-header rolltext">NEWS</a></li>
					<li class="gnav-list__item megamenu"><a href="company.html" class="js-header rolltext">COMPANY
						<span class="l-header__gnav__icon">
							<svg width="15" height="8" viewBox="0 0 15 8" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path d="M7.97929 6.58579L7.27219 7.2929L7.97929 8L8.6864 7.2929L7.97929 6.58579ZM14.2929 0.27219L7.97929 6.58579L8.6864 7.2929L15 0.9793L14.2929 0.27219ZM7.97929 6.58579L1.6657 0.272189L0.958601 0.979299L7.27219 7.2929L7.97929 6.58579Z" fill="white"></path>
							</svg>
						...
						<div class="downMenu2">
							<ul class="downMenu-list">
								<li class="downMenu-list__item"><a href="company.html#greeting" class="rolltext">代表挨拶</a></li>
								<li class="downMenu-list__item"><a href="company.html#staff" class="rolltext">メンバー紹介</a></li>
								<li class="downMenu-list__item"><a href="company.html#company_overview" class="rolltext">会社概要</a></li>
								<li class="downMenu-list__item"><a href="company.html#philosophy" class="rolltext">企業理念</a></li>
								<li class="downMenu-list__item"><a href="company.html#csr" class="rolltext">CSR活動</a></li>
							</ul>
						</div>
					</li>
					<li><a href="recruit.html" class="js-header rolltext">RECRUIT</a></li>
					<li><a href="contact.html" class="js-header rolltext">CONTACT</a></li>
				</ul>
				<!-- <h1>
					<div class="catch">テックプロパティジャパン</div>
				</h1> -->
			</nav>
    ...
    <section id="feature" class="feature">
		<div class="container">
			<div class="title">
				...
				<div class="thumb"><img src="./images/istockphoto-1465173464-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
			</div><!-- end .title -->
				...
				<div class="box">
					<div class="top">
						<div class="thumb">
							...
							<img src="./images/istockphoto-684807874-1024x1024.jpg" alt="*">
						</div><!-- end .thumb -->
						<div class="text">
				...
				<div class="box">
					<div class="top">
						<div class="thumb">
							...
							<img src="./images/istockphoto-2155679920-1024x1024.jpg" alt="*">
						</div><!-- end .thumb -->
						<div class="text">
				...
				<div class="box">
					<div class="top">
						<div class="thumb">
							...
							<img src="./images/istockphoto-1402697363-1024x1024.jpg" alt="*">
						</div><!-- end .thumb -->
						<div class="text">
			...
			<div class="box-wrapper">
				<div class="box">
					<div class="thumb-wrapper">
						<div class="thumb"><img src="./images/istockphoto-1484779739-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
						<div class="thumb"><img src="./images/istockphoto-1307949482-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
					...
					<div class="text">
						...
						<div class="inset">
							...
							<div class="sentence">
								...
								<p class="arrow-button"><a href="./service/club20.html" class="rolltext">利回り20%倶楽部の詳細はこちら</a></p>
							</div><!-- end .sentence -->
						</div><!-- end .inset -->
					</div><!-- end .text -->
				</div><!-- end .box -->
				<div class="box">
					<div class="thumb-wrapper">
						<div class="thumb"><img src="./images/istockphoto-1334786171-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
						<div class="thumb"><img src="./images/istockphoto-1365288940-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
					</div><!-- end .thumb-wrapper -->
					<div class="text">
						...
						<div class="inset">
							...
							<div class="sentence">
								...
								<p class="arrow-button"><a href="./service/new_apartment.html" class="rolltext">新築アパートプランの詳細はこちら</a></p>
							</div><!-- end .sentence -->
						</div><!-- end .inset -->
					</div><!-- end .text -->
				</div><!-- end .box -->
				<div class="box">
					<div class="thumb-wrapper">
						<div class="thumb"><img src="./images/istockphoto-1182155629-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
						<div class="thumb"><img src="./images/istockphoto-2164747867-1024x1024.jpg" alt="*"></div><!-- end .thumb -->
					</div><!-- end .thumb-wrapper -->
					<div class="text">
						...
						<div class="inset">
							...
							<div class="sentence">
								...
								<p class="arrow-button"><a href="./service/assessment.html" class="rolltext">不動産査定の詳細はこちら</a></p>
							</div><!-- end .sentence -->
						</div><!-- end .inset -->
					</div><!-- end .text -->
				</div><!-- end .box -->
    ...
    <section class="recruit">
        <div class="container">
			...
			<div class="box-wrapper">
				<div class="box">
					<div class="thumb-wrapper">
						<div class="thumb"><img src="./images/recruit/position01.jpg" alt="*"></div><!-- end .thumb -->
						<div class="thumb"><img src="./images/recruit/position02.jpg" alt="*"></div><!-- end .thumb -->
					</div><!-- end .thumb-wrapper -->
					<div class="text">
...
不動産×テクノロジーのプロフェッショナルに。
								...
								<p class="arrow-button"><a href="recruit.html" class="rolltext">採用情報の詳細はこちら</a></p>
							</div><!-- end .sentence -->
						</div><!-- end .inset -->
					</div><!-- end .text -->
				</div><!-- end .box -->
        ...
        <div class="container">
			...
			<div class="inner">
				...
				<div class="block">
					...
					<div class="form">
						<a href="#" class="rolltext" target="_blank">
    ...
    <footer class="footer">
        <div class="container">
			<div class="top">
				<div class="logo">
					<a href="index.html"><img src="./images/logo2.svg" alt="*" class="plane"></a>
					<!-- <img src="./images/logo-white.svg" alt="*" class="white"> -->
				</div><!-- end .logo -->
				<nav>
					<ul>
						<li><a href="index.html" class="rolltext"><p class="en">Home</p><p class="jp">ホーム</p></a></li>
						<li><a href="./service/index.html" class="rolltext"><p class="en">Service</p><p class="jp">サービス</p></a></li>
						<li><a href="http://52.0.121.178/id/techpro-j/wp/?page_id=6" class="rolltext"><p class="en">News</p><p class="jp">お知らせ</p></a></li>
						<li><a href="company.html" class="rolltext"><p class="en">Company</p><p class="jp">会社情報</p></a></li>
					</ul>
					<ul>
						<li><a href="recruit.html" class="rolltext"><p class="en">Recruit</p><p class="jp">採用情報</p></a></li>
						<li><a href="contact.html" class="rolltext"><p class="en">Contact</p><p class="jp">お問い合わせ</p></a></li>
					</ul>
				</nav>
			...
			<div class="privacy">
				<p><a href="privacy-policy.html" class="rolltext pri">PRIVACY POLICY</a></p>
				<p><a href="cookie-policy.html" class="rolltext coo">COOKIE POLICY</a></p>
			</div><!-- end .privacy -->
			<div class="copyright">
	...
	<script src="./js/common.js?ver=20250501"></script>
